...
urlpatterns = patterns('',
    ...
    url(r'^game/(?P<pk>[0-9]+)/mission/(?P<mk>[0-9]+)/generate/$', RequestAwardCode.as_view(), name='game|missioncode'),
    url(r'^game/(?P<pk>[0-9]+)/mission/(?P<mk>[0-9]+)/multigen/$', RequestMultipleAwardCode.as_view(), name='game|multimissioncode'),
    ...
    url(r'^game/(?P<pk>[0-9]+)/data/missions/$', MissionFeed.as_view(), name='game|data|missions'),
    url(r'^game/(?P<pk>[0-9]+)/data/missions/all/$', MissionFeedAll.as_view(), name='game|data|missions|all'),
    url(r'^game/(?P<pk>[0-9]+)/data/humans/$', Humans.as_view(), name='game|data|humans'),
    url(r'^game/(?P<pk>[0-9]+)/data/zombies/$', Zombies.as_view(), name='game|data|zombies'),
    url(r'^game/(?P<pk>[0-9]+)/data/zcommando/$', ZCommando.as_view(), name='game|data|commando|zombies'),
    url(r'^game/(?P<pk>[0-9]+)/data/hcommando/$', HCommando.as_view(), name='game|data|commando|humans'),
    url(r'^game/(?P<pk>[0-9]+)/data/allplayers/$', Players.as_view(), name='game|data|allplayers'),
