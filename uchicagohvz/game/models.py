...
HALLS = (
	...
	('Courtenay-Latimer', ['ORI', 'JAM', 'BEI']),
	('Desmond Tutu', ['ELL', 'AMI', 'CAL', 'MAR', 'HI3', 'OAK']),
	('Drostdy', ['ALL', 'CEL', 'GRA', 'PRA']),
	('Founders', ['BOT', 'COR', 'MAT']),
	('Hobson', ['DIN', 'HOB', 'LIV', 'MIL']),
	('Jan Smuts', ['ADA', 'ATH', 'JAN', 'NEW']),
	('Miriam Makeba', ['CHR', 'PIE', 'THO', 'WAL']),
	('Kimberley', ['CB', 'DB', 'ROS', 'GOL']),
	('Lilian Ngoyi', ['CEN', 'RUT', 'JOE', 'VIC']),
	('Nelson Mandela', ['SKI', 'ADE', 'GUY', 'HEL']),
	('St Mary', ['JOH', 'LIL', 'OLI', 'PHE']),
	("Oppidan", ['OPP'])
)
...
class Mission(models.Model):
	...
	name = models.CharField(max_length=255)
	pos = GeopositionField(null=True, blank=True, verbose_name='position')
	desc = models.CharField(max_length=255, blank=True, default='', verbose_name='description')
	# lat = models.FloatField(null=True, blank=True, verbose_name='latitude')
	# lng = models.FloatField(null=True, blank=True, verbose_name='longitude')
